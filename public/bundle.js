  ...
  var require_observable = __commonJS({
    'node_modules/@riotjs/observable/dist/observable.js'(exports, module) {
      (function (window2, undefined2) {
        ...
        if (typeof exports === 'object') module.exports = observable6;
        else if (typeof define === 'function' && define.amd)
          define(function () {
            return observable6;
          });
        else window2.observable = observable6;
      ...
      if (aEnd === aStart) {
        ...
        if (map5.has(a[aStart])) {
          ...
          if (bStart < index && index < bEnd) {
            let i = aStart;
            let sequence = 1;
            while (++i < aEnd && i < bEnd && map5.get(a[i]) === index + sequence) sequence++;
...
interface Floor {
  ...
  var asElevatorInterface = function (obj2, elevator, floorCount, errorHandler) {
    ...
    elevatorInterface.goToFloor = function (floorNum, forceNow) {
      ...
      if (elevatorInterface.destinationQueue.length) {
        var adjacentElement = forceNow
          ? (0, import_first.default)(elevatorInterface.destinationQueue)
          : (0, import_last.default)(elevatorInterface.destinationQueue);
    ...
    elevator.on('stopped', function (position) {
      if (
        ...
        epsilonEquals((0, import_first.default)(elevatorInterface.destinationQueue), position)
      ) {
  ...
  var createWorldCreator = function () {
    ...
    creator.createElevators = function (elevatorCount, floorCount, floorHeight, elevatorCapacities) {
      ...
      var elevators = (0, import_map3.default)((0, import_range2.default)(elevatorCount), function (e, i) {
        var elevator = new elevator_default(
          2.6,
          floorCount,
          floorHeight,
  ...
  var createParamsUrl = function (current, overrides) {
    return (
      '#' +
      (0, import_map4.default)((0, import_merge.default)(current, overrides), function (val, key) {
        return key + '=' + val;
      }).join(',')
    );
  };
