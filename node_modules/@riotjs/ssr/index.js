...
const create$2 = (ownerDocument, element, localName)  => {
...
let Element$1 = class Element extends ParentNode {
  ...
  cloneNode(deep = false) {
    ...
    const clone = create$2(ownerDocument, this, localName);
    ...
    while (next !== prev && (deep || next.nodeType === ATTRIBUTE_NODE)) {
      switch (next.nodeType) {
        case NODE_END:
          ...
          break;
        case ELEMENT_NODE: {
          const node = create$2(ownerDocument, next, next.localName);
          addNext(node);
          parentNode = node;
          break;
        }
...
const renderAsync = curry(createRenderer)(
  renderComponentAsync((rendererPayload) =>
    getOnlyHTMLFromRenderer(rendererPayload, true),
  ),
);
const renderAsyncFragments = curry(createRenderer)(
  renderComponentAsync((rendererPayload) =>
    getFragmentsFromRenderer(rendererPayload, true),
  ),
);
const fragments = curry(createRenderer)(getFragmentsFromRenderer);
const render = curry(createRenderer)(getOnlyHTMLFromRenderer);

export { asyncRenderTimeout, createRenderer, render as default, domGlobals, fragments, render, renderAsync, renderAsyncFragments };
